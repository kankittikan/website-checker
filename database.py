...
class ServerInfo(Base):
    ...
    cpu_threshold: Mapped[float] = mapped_column(default=90.0)
    ram_threshold: Mapped[float] = mapped_column(default=90.0)
    disk_threshold: Mapped[float] = mapped_column(default=90.0)
    last_checked: Mapped[datetime] = mapped_column(default=lambda: datetime.now(UTC))
